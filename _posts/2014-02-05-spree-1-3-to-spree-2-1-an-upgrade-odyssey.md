...
suggestions into the post. Thanks for reading!
  ...
  [new store button]: {{ "/assets/new-store.png" | absolute_url }}
  [register button]: {{ "/assets/register.png" | absolute_url }}
  [environment details]: {{ "/assets/details.png" | absolute_url }}
  [add server]: {{ "/assets/add-server.png" | absolute_url }}
  [configuration complete]: {{ "/assets/complete.png" | absolute_url }}
  ...
  [initialize server]: {{ "/assets/initialize.png" | absolute_url }}
  ...
  [capistrano recipe]: {{ "/assets/capistrano.png" | absolute_url }}
